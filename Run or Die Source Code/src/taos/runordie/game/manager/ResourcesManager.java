package taos.runordie.game.manager;
...
import taos.runordie.game.GameActivity;
...
public class ResourcesManager {
	...
	public ITextureRegion suelo_region;
	...
	private void loadGameGraphics() {
		...
		gameTextureAtlas = new BuildableBitmapTextureAtlas(
				activity.getTextureManager(), 1024, 1024,
				TextureOptions.BILINEAR);
		suelo_region = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(gameTextureAtlas, activity, "suelo.png");
		...
		complete_stars_region = BitmapTextureAtlasTextureRegionFactory
				.createTiledFromAsset(gameTextureAtlas, activity, "meta.png",
						2, 1);
