package taos.runordie.game.scene;
...
import taos.runordie.game.base.BaseScene;
import taos.runordie.game.extras.LevelCompleteWindow;
import taos.runordie.game.extras.LevelCompleteWindow.StarsCount;
import taos.runordie.game.manager.SceneManager;
import taos.runordie.game.manager.SceneManager.SceneType;
import taos.runordie.game.object.Player;
...
public class GameScene extends BaseScene implements IOnSceneTouchListener {
	...
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_SUELO = "suelo";
		...
		levelLoader
				.registerEntityLoader(new EntityLoader<SimpleLevelEntityLoaderData>(
					...
					public IEntity onLoadEntity(
						...
						if (type.equals(TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_SUELO)) {
							levelObject = new Sprite(x, y,
									resourcesManager.suelo_region, vbom);
							PhysicsFactory.createBoxBody(physicsWorld,
									levelObject, BodyType.StaticBody,
									FIXTURE_DEF).setUserData("suelo");
